<template>
  <div class="flex" v-if="state.isSubscribed !== null">
    <ToggleButton class="w-8rem h-3rem border-round-2xl" v-if="isLogged" v-model="state.isSubscribed" @click="updateSubscribtion(reputationObjectId, reputationObjectType)" :disabled="!isLogged" onLabel="Unread" offLabel="Read" onIcon="pi pi-check" offIcon="pi pi-times">
    </ToggleButton>
  </div>
</template>
