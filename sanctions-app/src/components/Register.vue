        ...
        <div class="card card-container">
            ...
            <form name="form" @submit.prevent="handleLogin(!v$.$invalid)">
                <div class="form-group">
                    ...
                    <InputText type="text" id="login" v-model="v$.username.$model" :class="{'p-invalid':v$.username.$invalid && loading}"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="confirmation" :class="{'p-error':v$.confirmation.$invalid && submitted || password != confirmation }">Password confirmation</label>
                    <Password id="confirmation" v-model="v$.confirmation.$model" :class="{'p-invalid':v$.confirmation.$invalid && submitted || password != confirmation}" toggleMask>
                        <template #header>
...
export default {
  ...
  methods: {
    handleLogin(isFormValid) {
        ...
        if (!isFormValid || this.password != this.confirmation) {
            this.loading = false;
            return;
        }
