			...
			<template #list="slotProps">
				<div class="col-12">
					<div class="element-list-item">
						<img v-if="slotProps.data.foto" :src="`${staticfiles}/fotos/sanctions/organizations/${slotProps.data.foto}`" class="photo-list" :alt="slotProps.data.titleeng"/>
			...
			<template #grid="slotProps">
				<div class="col-12 md:col-4 display-grid">
					<div class="element-grid-item card">
						...
						<img v-if="slotProps.data.foto" :src="`${staticfiles}/fotos/sanctions/organizations/${slotProps.data.foto}`" class="photo-grid" :alt="slotProps.data.titleeng"/>
